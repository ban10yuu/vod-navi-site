...
export default function ContactPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-[#121826] rounded-xl shadow-sm border border-white/[0.06] p-6 md:p-8 space-y-6 text-[0.95rem] leading-relaxed text-slate-200">
        <p>
        ...
        <div className="bg-amber-400/10 border border-amber-400/20 rounded-xl p-6">
          <h2 className="text-lg font-bold text-white mb-4 pl-3 border-l-4 border-amber-400">
            メールアドレス
          </h2>
          <p className="mb-2">
            <a
              href="mailto:ban10yuu@icloud.com"
              className="text-amber-400 hover:underline font-mono text-base"
            >
              ban10yuu@icloud.com
            </a>
          </p>
